...
public interface Position {
    ...
    void addProduct(Store store, int productID, int itemsAmount) throws IllegalAccessException;
    List<Purchase> getPurchaseHistory(Store store) throws IllegalAccessException;
