...
class ShoppingCartTest extends TestCase {
    ...
    void beforeEach() throws Exception {
        ...
        product1 = new Product(storeId1,1,"wine", 3, "60.0", 3, "alcohol", ProductDTO.PurchaseType.BUY_IT_NOW);
        product2 = new Product(storeId1,2, "cheese", 9.5, "milk", 4, "fads", ProductDTO.PurchaseType.BUY_IT_NOW);
...
//    }
    ...
    void changeProductQuantity() throws Exception {
        market.addProduct(sessionId1, storeId1, product1.getProductName(),20.0,"cat",50,"wow", ProductDTO.PurchaseType.BUY_IT_NOW);
